...
def add_house(id, name, floors, persons, beds, rooms, bbq, water, photos_dir, small_disc, big_disc):
    new_house = House(
        id=id, 
        name=name,
        floors = floors, 
...
add_house(id, name, floors, persons, beds, rooms, bbq, water, photos_dir, small_disc, big_disc)