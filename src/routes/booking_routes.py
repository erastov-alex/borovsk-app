...
@bookings_bp.route(
    "/edit_start_date/<int:booking_id>/<int:house_id>/<string:start_date>/<string:end_date>",
    methods=["GET", "POST"],
)
@login_required
def edit_start_date(booking_id, house_id, start_date, end_date):
    ...
    if request.method == "POST":
        ...
        return render_template(
            "users/edit_booking.html", booking=booking, active_page="user_panel"
        )


@bookings_bp.route(
    "/edit_end_date/<int:booking_id>/<int:house_id>/<string:start_date>/<string:end_date>",
    methods=["GET", "POST"],
)
@login_required
...
@bookings_bp.route(
    "/edit_booking/<int:booking_id>/<int:house_id>/<string:start_date>/<string:end_date>",
    methods=["GET", "POST"],
)
@login_required
